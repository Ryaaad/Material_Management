...
const AddMember:React.FC<props> = (props) => {
    ...
    <h1  className="text-center text-3xl font-semibold md:text-2xl xs:text-xl " > Add New <span  className='text-[#3069FE] '>Member</span> </h1>
    ...
    <div className='mt-5 xs:mt-3' >
        <h1 className='text-[#33333] text-lg  xs:text-[16px] ' >First Name</h1>
    ...
    <div className='mt-3 xs:mt-2' >
        <h1 className='text-[#33333] text-lg  xs:text-[16px]  ' >Last Name</h1>
        <input type="text" placeholder="Last Name Here" className="w-full border border-[#D9D9D9] p-2 pl-3 mt-1 rounded-[8px] md:py-[6px] " />
    </div>

    <div className='mt-3 xs:mt-2' >
        <h1 className='text-[#33333] text-lg  xs:text-[16px]  ' >Phone Number</h1>
        <input type="text" placeholder="Phone Number Here" className="w-full border border-[#D9D9D9] p-2 pl-3 mt-1 rounded-[8px] md:py-[6px] " />
    </div>

    <div className='mt-3 xs:mt-2 mb-5 xs:mb-3 ' >
        <h1 className='text-[#33333] text-lg  xs:text-[16px]  ' >Discord Id</h1>
